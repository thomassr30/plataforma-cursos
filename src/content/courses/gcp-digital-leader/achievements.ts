...
export const achievements: Achievement[] = [
  ...
  { id: "xp_100", icon: "⭐", name: "Cloud Explorer", desc: "100 XP", threshold: { type: "xp", value: 100 } },
  { id: "xp_500", icon: "🚀", name: "Cloud Architect", desc: "500 XP", threshold: { type: "xp", value: 500 } },
  { id: "xp_1000", icon: "🏆", name: "Mil XP", desc: "1000 XP", threshold: { type: "xp", value: 1000 } },
  { id: "modules_3", icon: "📚", name: "Iniciado en GCP", desc: "3 módulos completos", threshold: { type: "modules", value: 3 } },
  { id: "modules_7", icon: "🎓", name: "Avanzado", desc: "7 módulos completos", threshold: { type: "modules", value: 7 } },
  { id: "modules_all", icon: "🏅", name: "Digital Leader Master", desc: "10 módulos completos", threshold: { type: "modules", value: 10 } },
  { id: "srs_50", icon: "🧠", name: "Memoria Cloud", desc: "50 términos dominados", threshold: { type: "words", value: 50 } },
  { id: "final_passed", icon: "🎖️", name: "Certificado GCDL", desc: "Aprueba el examen final", threshold: { type: "final", value: 1 } },
];
