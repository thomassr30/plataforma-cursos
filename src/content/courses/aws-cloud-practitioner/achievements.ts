...
export const achievements: Achievement[] = [
  ...
  { id: "xp_100", icon: "⭐", name: "Cloud Beginner", desc: "100 XP", threshold: { type: "xp", value: 100 } },
  { id: "xp_500", icon: "🚀", name: "Cloud Practitioner", desc: "500 XP", threshold: { type: "xp", value: 500 } },
  { id: "xp_1000", icon: "🏆", name: "Mil XP", desc: "1000 XP", threshold: { type: "xp", value: 1000 } },
  { id: "modules_3", icon: "📚", name: "Iniciado en AWS", desc: "3 módulos completos", threshold: { type: "modules", value: 3 } },
  { id: "modules_7", icon: "🎓", name: "Avanzado", desc: "7 módulos completos", threshold: { type: "modules", value: 7 } },
  { id: "modules_all", icon: "🏅", name: "Cloud Practitioner Master", desc: "10 módulos completos", threshold: { type: "modules", value: 10 } },
  { id: "srs_50", icon: "🧠", name: "Memoria AWS", desc: "50 términos dominados", threshold: { type: "words", value: 50 } },
  { id: "final_passed", icon: "🎖️", name: "Certificado CCP", desc: "Aprueba el examen final", threshold: { type: "final", value: 1 } },
];
